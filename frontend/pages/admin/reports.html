...
<head>
  ...
  <title>Admin Reports – AgriCrop</title>
...
<aside class="ag-sidebar" id="sidebar">
  ...
  <a href="reports.html" class="sidebar-link active"><span class="link-icon">📄</span> All Reports</a>
...
<main class="ag-content-area ag-page">
  <div class="section-header mb-4">
    <div>
      <h2 class="section-title">📄 All Farm Reports</h2>
      <p class="section-subtitle">Monitor and download PDF/CSV reports generated by platform farmers.</p>
    </div>
    <button onclick="initAdminReports()" class="btn-ag-secondary" style="font-size:0.82rem;">🔄 Refresh List</button>
  </div>
